...
| **GNS3** | Client-server-model, meerdere GUI-clients op dezelfde server; ondersteunt QCOW2/IMG/ISO native; multi-user gelijktijdig | Vereist installatie van desktop GUI-client op de laptop van elk teamlid |
