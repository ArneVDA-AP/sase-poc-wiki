---
title: "Bevinding: Unbound 1.24.2 ondersteunt geen TSIG voor zone transfers"
tags: [finding, network, ioc2rpz]
---

# Bevinding: Unbound 1.24.2 ondersteunt geen TSIG voor zone transfers
...
ioc2rpz vereist TSIG-authenticatie voor autorisatie van zone transfer. Zonder dit worden AXFR-verzoeken door ioc2rpz geweigerd.

## Oorzaak

Unbound 1.24.2 implementeert TSIG niet voor inkomende zone transfers (`rpz: primary:`-configuratie). Dit is een gedocumenteerde ontbrekende functie in NLnetLabs/unbound GitHub issue #336, open sinds oktober 2020.

## Oplossing / workaround

BIND 9.20 (OPNsense `os-bind`-plugin) invoegen als intermediary. BIND verwerkt de TSIG-geauthenticeerde AXFR van ioc2rpz en presenteert de zone aan Unbound via loopback op `127.0.0.1:53530` zonder authenticatie.

Zie [Beslissing: BIND als TSIG-intermediary](../decisions/bind-tsig-intermediary.md).
