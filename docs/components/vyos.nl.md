...
> **Build-opmerking:** op deze rolling-build mapt een percentage-`ceiling` verkeerd naar `tc` (`ceiling '30%'` wordt `ceil 3Gbit`, effectief onbegrensd). Classificatie en prioriteit werken correct; alleen ceiling-handhaving is getroffen — benign voor de PoC-demo.
